      ...
      <div className='mt-3'>
        ...
        <button className='font-semibold'>Forgot Password?</button>
            ...
            <Link to="/">
              ...
              <button className='flex border-2 py-1 rounded-md border-gray-200 items-center justify-center gap-2 activ:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all' onClick={signInWithGoogle}>
